                     ...
                     @foreach ($Arls as $arl)
                        <div id="toast-interactive" class="m-4 ml-8 justify-center inline-block mb-2 max-w-xs p-1 text-gray-500 bg-white rounded-lg shadow-2xl dark:bg-gray-800 dark:text-gray-400" role="alert">
                            <div class="flex">
                                ...
                                <div class="ms-1">
                                    <span class="mb-1 text-xs font-bold text-gray-900 dark:text-white">{{$arl->nombre}}</span>
                                    <div class="mb-1 text-xs font-italic text-blue-600">Nit: {{$arl->nit}} &nbsp; Cod: {{$arl->codigo}}</div> 
                                     <div class="mb-2"></div> 
