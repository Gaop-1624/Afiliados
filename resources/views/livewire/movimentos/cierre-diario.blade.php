<div>
   ...
   <x-titulo><i class="fas fa-cloud-sun" style="color: rgb(166, 168, 166)"></i> &nbsp; {{__('Daily Closing')}}</x-titulo>
                ...
                <div>
                    <div class="justify-center px-4 py-1 text-center m-4">
                        <div class="border-2 bg-white rounded p-1">  
                             <a href="{{ route('Reports.IngresosEgresos.Dia', ['fecha_inicio' => $fecha, 'fecha_fin'  => $fecha]) }}" class="inline-flex border py-1 px-1 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-100 dark:bg-blue-200 dark:hover:bg-green-400 dark:focus:ring-green-600" title="{{__('Print')}}">
                            ...
                            <a href="#" wire:click="closemodal()" class="inline-flex border py-1 px-1 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-100 dark:bg-blue-200 dark:hover:bg-green-400 dark:focus:ring-green-600" title="{{__('Look for')}}">
                        ...
                        <table class="min-w-full text-sm font-light text-center m-2">
                                <thead class="text-white bg-blue-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-2 py-1 font-serif text-xs">{{__('Details')}}</th>
                                        <th scope="col" class="px-2 py-1 font-serif text-xs">{{__('Income')}}</th>
                                        <th scope="col" class="px-2 py-1 font-serif text-xs">{{__('Bills')}}</th>
{{--                                         <th scope="col" class="px-2 py-1 font-serif text-xs">{{__('Exit')}}</th>
 --}}                                   </tr>
                                </thead>
                                <tbody>
