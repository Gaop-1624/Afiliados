   ...
   <x-titulo><i class="fas fa-archive"></i> &nbsp; {{__('List Compensation')}}</x-titulo>
    ...
    @if ($cajas->count())
          @foreach ($cajas as $caja)            
                    <div class="items-start gap-1 inline-block  ml-16 mt-2">
                                ...
                                <div class="flex items-start bg-neutral-secondary-soft rounded-xl p-1">
                                    <div class="me-1.5">
                                        <span class="flex items-center gap-2 text-sm font-medium text-heading pb-2">
                                            <span class="mb-1 px-4 text-xs font-bold text-white dark:text-white  bg-cyan-400 w-full"><i class="fas fa-server fa fw" style="color: white"></i> &nbsp; {{$caja->nombre}}</span>
                                        </span>
                                        <h5 class="text-left text-xs text-stone-400 font-semibold border-b-2 rounded-sm shadow-2xl mb-1">Nit: {{ $caja->nit}} &nbsp; Cod: {{ $caja->codigo}}</h5>
                                        <div class="grid grid-cols-2 gap-4">
                                            <div></div>
                                            <div class="justify-end">
                                                @can('admin.caja.edict')
