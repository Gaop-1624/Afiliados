    ...
    <x-card>
        ...
        <div class="grid grid-cols-1 gap-2 lg:grid-cols-4 lg:gap-2 mb-2  m-2">
            ...
            <div class="flex justify-end border-x-0 mb-4">
                <button wire:click.prevent="update({{$Empresa}})" class="px-6 py-1 mr-2 h-7 text-xs font-semibold text-center inline-flex items-center text-white bg-blue-700 rounded-lg hover:bg-blue-600 focus:ring-4 focus:outline-none focus:ring-blue-300"><i class="fas fa-save fa-stack fa-lg"></i>{{__('Save')}} </button>
